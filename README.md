...
> La unica ventaja que tienen grupos para este caso concreto es para tener el codigo mas legible
...
**¿Qué error os da VS Code si intentáis poner dos servidores con el mismo ID?**
    ...
    cvc-identity-constraint.4.1: Duplicate unique value [srv-web-01] found for identity constraint "UnicoID" of element "catalogo_cloud".
